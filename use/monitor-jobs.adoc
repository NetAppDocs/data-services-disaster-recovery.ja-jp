...
[role="lead"]
すべてのNetAppディザスタ リカバリ ジョブを監視し、その進行状況を確認できます。



== ジョブの表示

*必要なNetAppコンソール ロール* 組織管理者、フォルダまたはプロジェクト管理者、ディザスタ リカバリ管理者、ディザスタ リカバリ アプリケーション管理者、またはディザスタ リカバリ ビューア ロール。
...
.手順
. NetAppコンソールの左側のナビゲーション バーから、*保護* > *災害復旧* を選択します。
. メニューから*ジョブ監視*を選択します。
