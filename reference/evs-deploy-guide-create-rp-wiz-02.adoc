...
summary: Amazon EVS とAmazon FSx for NetApp ONTAPを使用したNetApp Disaster Recoveryの紹介。  NetApp Disaster Recoveryを使用して保護する仮想マシンを選択します。 
---
...
* *以前に作成したリソース グループを選択*: NetApp Disaster Recoveryメニューの [リソース グループ] オプションを使用して、事前にカスタム リソース グループを作成できます。他の 2 つの方法を使用して、レプリケーション プラン プロセスの一部としてリソース グループを作成できるため、これは必須ではありません。詳細については、 link:../use/drplan-create.html["レプリケーションプランを作成する"] 。
