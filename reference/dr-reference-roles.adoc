...
summary: NetApp Disaster Recovery、ロールを使用して、各ユーザーの特定の機能やアクションへのアクセスを制御します。 
---
...
これらのロールはNetApp Disaster Recoveryに固有のものであり、 NetApp Consoleで使用されるプラットフォーム ロールとは異なります。  NetApp Consoleプラットフォームのすべてのロールの詳細については、 https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html["NetApp Consoleのセットアップと管理に関するドキュメント"^] 。
