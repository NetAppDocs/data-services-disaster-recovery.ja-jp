...
[role="lead"]
必要な ONTAP 権限を設定して、NetApp Disaster Recovery が正常に機能するようにします。
...
Disaster Recovery には、次の ONTAP 権限が必要です：
...
ONTAP で権限を追加するには、必要な権限を持つロールを作成し、それをユーザーに割り当てます。このタスクは、System Manager または ONTAP CLI を使用して ONTAP で実行できます。
