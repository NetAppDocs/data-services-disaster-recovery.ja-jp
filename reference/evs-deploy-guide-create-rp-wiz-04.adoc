...
summary: Amazon EVS とAmazon FSx for NetApp ONTAPを使用したNetAppディザスタリカバリの紹介。  NetApp Disaster Recovery ですべてのレプリケーション プラン情報を追加したら、入力した情報が正しいことを確認します。 
---
...
[role="lead"]
NetApp Disaster Recovery でレプリケーション プラン情報を追加した後、入力した情報が正しいことを確認します。
