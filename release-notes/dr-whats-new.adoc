...
詳細については、 link:https://docs.netapp.com/us-en/data-services-disaster-recovery/use/drplan-create.adoc["レプリケーションプランを作成する"]。
...
詳細については、 link:https://docs.netapp.com/us-en/data-services-disaster-recovery/reference/switch-console-agents.html["スイッチコンソールエージェント"]。
